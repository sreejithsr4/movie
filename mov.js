function movieSearch() {
    movie = movie.value
    fetch(`http://www.omdbapi.com/?t=${movie}&apikey=222e9039`).then(data => data.json()).then(movie => displayMovie(movie))
    function displayMovie(arrayMovie) {
        ...
        <div class="col-md-8 mt-3"><p>Summary:${plot}</p> <p>Director:${dir}</p><p>Writer:${writer}</p>
